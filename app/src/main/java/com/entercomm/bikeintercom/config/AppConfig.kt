...
object AppConfig {
    ...
    object WiFiDirect {
        ...
        const val DISCOVERY_TIMEOUT_MS = 30000L // Max time to wait for peer discovery
        const val AUTO_CONNECT_DELAY_MS = 15000L // Max time to establish connection after discovery
        const val SERVICE_DISCOVERY_INTERVAL_MS = 5000L // Interval between service discovery attempts
